...
const TeamTable = ({ team, teamB }: { team: Team; teamB?: Team }) => {
  ...
  let columns = [
    ...
    },
    {
      ...
      getInfo: (s: Score) => percent(s.win, s.game) + formatRank(s.ranks?.win),
      up: true,
      active: !!teamB,
      needTeam: false,
    },
    {
      ...
      getInfo: (s: Score) =>
        percent(s.neutral, s.game) + formatRank(s.ranks?.neutral),
      up: true,
      active: false,
      needTeam: false,
    },
    {
      ...
      getInfo: (s: Score) =>
        percent(s.loss, s.game) + formatRank(s.ranks?.loss),
      up: false,
      active: !!teamB,
      needTeam: true,
    },
    {
      ...
      getInfo: (s: Score) =>
        average(s.goalFor, s.game) + formatRank(s.ranks?.goalFor),
      up: true,
      active: true,
      needTeam: false,
    },
    {
      ...
      getInfo: (s: Score) =>
        average(s.goalAgainst, s.game) + formatRank(s.ranks?.goalAgainst),
      up: false,
      active: true,
      needTeam: false,
    },
    {
      ...
      getInfo: (s: Score) =>
        percent(s.shutOut, s.game) + formatRank(s.ranks?.shutOut),
      up: true,
      active: true,
      needTeam: false,
    },
    {
      ...
      getInfo: (s: Score) =>
        average(s.goalDiff, s.game) + formatRank(s.ranks?.goalDiff),
      up: true,
      active: true,
      needTeam: false,
    },
